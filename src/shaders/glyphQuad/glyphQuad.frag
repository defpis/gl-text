...
void main()
{
    fout_color1 = vec4(vec3(0.0), 1.0);
    fout_color2 = vec4(vec3(0.0), 1.0);
    float v = vout_barycentric.y * 0.5 + vout_barycentric.x;
    v = v * v;
    if (v < vout_barycentric.x) 
    {
